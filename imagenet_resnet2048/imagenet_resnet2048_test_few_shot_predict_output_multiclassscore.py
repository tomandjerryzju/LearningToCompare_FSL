            ...
            if len(pic_arrays) == batch_size:
                try:
                    ...
                    for i in range(len(relations)):
                        ...
                        if relations[i][1] > 0.6:
                            predict_label = 1
                            predict_score = relations[i][1]
                        # if predict_score <= 0.5:
                        #     predict_label = 6
                        line = [filename_list[i], str(relations[i][0]), str(relations[i][1])]
                        line = '\t'.join(line) + '\n'
                        fout.write(line)
...
def main():
    ...
    support_set = "/Users/hyc/workspace/LearningToCompare_FSL/datas/imagenet_resnet2048/support_set_baolinqiu"
    # image_root = "/Users/hyc/workspace/datasets/fetch_extent_pic/fsl_test_100_checked"
    image_root = "/Users/hyc/workspace/LearningToCompare_FSL/datas/imagenet_resnet2048/fsl_class6_top1000/0"
    ...
    checkpoint_path = "./models/imagenet_resnet2048_relation_network_10way_20shot.pkl"
    ...
    batch_predict(feature_encoder, relation_network, support_set, 2, 20, image_root, output_file, batch_size=20)
