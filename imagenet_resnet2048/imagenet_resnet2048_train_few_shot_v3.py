...
import numpy as np
import task_generator_test_v2 as tg
import os
import math
import argparse
import scipy as sp
...
def main():
    ...
    checkpoint_path = str("./models/imagenet_resnet2048_relation_network_"+ str(CLASS_NUM) +"way_" + str(SAMPLE_NUM_PER_CLASS) +"shot_" + str(RELATION_DIM) +"hidden.pkl")
